...
#train_one_epoch(epoch, train_loader, hcolor_model, ce_loss, optimizer, meta_dict, train_plotter, logger, gpu_no, is_ddp) 호출
    try:
    ...
    for batch_idx, sample_batch in enumerate(data_loader):
        ...
        optimizer.step()
        #loss.AnchorColorProbLoss(hint2regress=args.hint2regress, enhanced=args.enhanced, with_grad=args.in_gradient, mpdist=is_ddp, gpu_no=gpu_no)
